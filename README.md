...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
 Relational Databases  manage databases, while SQL is used to access those databases and allow you to query your Relational Database.
...
a third table that will hold the relation between the two tables
